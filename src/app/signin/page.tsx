...
export default function SignInPage() {
  ...
  const handleCredentialsSubmit = async (e: React.FormEvent) => {
    ...
    const result = await signIn('credentials', {
      redirect: false, // Fontos: nem irányít át automatikusan, hogy tudjuk kezelni a hibát
      email,
      password,
    });
    ...
    <main className="flex items-center justify-center min-h-screen bg-slate-100 dark:bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        ...
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-2 border rounded-md dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
        >
